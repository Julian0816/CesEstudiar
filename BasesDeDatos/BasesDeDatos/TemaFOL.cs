...
{
    public class TemaFol
    {
        public void llamarQuestionario1()
        {
            string[] tema = {"El trabajador siempre tiene que cumplir las órdenes dadas por el empresario: // No, hay supuestos en los que no tiene que cumplirlas",
        ...
        {
            string[] tema = {"El encadenamiento de contratos se produce cuando // Existen dos o más contratos que superan los 24 meses en un periodo de 30 meses",
        ...
        {
            string[] tema = {"La duración máxima de un contrato en prácticas es de: // Dos años",
        ...
        {
            string[] tema = {"El descanso mínimo semanal para los mayores de edad es de: // Un día y medio",
        ...
        {
            string[] tema = {"La excedencia por cuidado de un familiar reserva el puesto de trabajo que el trabajador ocupaba durante // Un año",
        ...
        {
            string[] tema = {"En el cálculo de las indemnizaciones la cantidad que tenemos en cuenta para el finiquito es? // Se lleva al finiquito la cantidad menor",
        ...
        {
            string[] tema = {"Indica, de los siguientes colectivos, quienes no tienen derecho a la sindicación // Los miembros de las Fuerzas Armadas",
        ...
        {
            string[] tema = {"La edad de jubilación es // Aumenta progresivamente hasta el año 2027 que será de 67 años",
        ...
        {
            string[] tema = {"Para poder hablar de accidente de trabajo, ¿qué requisitos es necesario que concurran? // Que sea en el trabajo por cuenta ajena, que haya lesión corporal y que exista relación causa-efecto entre accidente y trabajo",
        ...
        {
            string[] tema = {"Para que se produzca un incendio son necesarios: // Un combustible, un comburente, una energía de activación y una reacción en cadena",
        ...
        {
            string[] tema = {"El orden correcto de actuación ante una situación de emergencia es: // Alerta, alarma, intervención y evacuación.",
        ...
        {
            string[] tema = {"Las medidas para controlar o eliminar un riesgo se proponen en: // La planificación de la actividad preventiva.",
        ...
        {
            string[] tema = {"Cuando se habla de primeros auxilios, PAS significa: // Proteger, avisar, socorrer",
        ...
        {
            string[] tema = {"El Europass: // Contiene el curriculum vitae europeo.",
        ...
        {
            string[] tema = {"Son características de los equipos de trabajo: // Todas las opciones son correctas. (Perseguir un objetivo común., Tener conciencia de pertenencia al equipo., Dotarse de una estructura básica.)",
        ...
        {
            string[] tema = {"Una controversia clara indica que: // Las partes comunican que existe un problema que hay que resolver.",
